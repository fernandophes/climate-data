...
public class GatewayConnection extends RabbitMqConnection<String> {
    ...
    public GatewayConnection(final MqConnectionData data, final Class<String> messageType, final String queue, final String exchange,
    ...
    public GatewayConnection(final String queue, final String exchange, final String exchangeType, final String routingKey,
